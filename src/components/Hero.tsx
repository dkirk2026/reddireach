...
export default function Hero() {
  return (
    <section className="pt-24 pb-20 md:pt-36 md:pb-32 bg-white overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 border border-orange-200/60 bg-orange-50/50 rounded-full">
              <svg className="w-4 h-4 text-[#ff4500] flex-shrink-0" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
