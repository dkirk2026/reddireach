...
const footerLinks = {
  ...
  resources: [
    { name: "Reddit Marketing Guide", href: "#" },
    { name: "Subreddit Finder", href: "#" },
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-[#ff4500] rounded-full flex items-center justify-center transition-colors">
